"""Flask API Entry points for the application."""
__author__ = 'pallawi'

from flask import Flask
from flask_restx import Api

from .routes.fileupload import upload_bp, file_ns, embedding_ns, metadata_ns
from .routes.question import question_ns
